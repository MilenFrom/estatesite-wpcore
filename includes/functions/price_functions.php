...
if( !function_exists('houzez_listing_price_by_id') ) {
    function houzez_listing_price_by_id( $propID )
    {
        ...
        $sale_price = \EstateSite\Core\Property::get( $propID, 'price' );
        $second_price     = \EstateSite\Core\Property::get( $propID, 'sec_price' );
        $price_postfix = \EstateSite\Core\Property::get( $propID, 'price_postfix' );
        $price_separator = houzez_option('currency_separator');
...
if( ! function_exists('houzez_is_price_placeholder') ) {
    function houzez_is_price_placeholder( $listing_id, $attr = 'li' ) {
        $is_price_placeholder   = \EstateSite\Core\Property::get( $listing_id, 'show_price_placeholder' );
...
if( !function_exists('houzez_project_price_v1') ) {
    function houzez_project_price_v1() {
        $output = '';
        $sale_price     = \EstateSite\Core\Property::get( get_the_ID(), 'project_price' );
        $price_postfix  = \EstateSite\Core\Property::get( get_the_ID(), 'project_price_postfix' );
        $price_prefix  = \EstateSite\Core\Property::get( get_the_ID(), 'project_price_prefix' );
        $price_separator = houzez_option('currency_separator');
...
if( !function_exists('houzez_listing_price_for_print') ) {
    function houzez_listing_price_for_print( $propID )
    {
        ...
        $second_price     = \EstateSite\Core\Property::get( $propID, 'sec_price' );
        $price_postfix  = \EstateSite\Core\Property::get( $propID, 'price_postfix' );
        $price_prefix  = \EstateSite\Core\Property::get( $propID, 'price_prefix' );
        $price_separator = houzez_option('currency_separator');
...
if( !function_exists( 'houzez_property_price_admin' ) ) {
    function houzez_property_price_admin () {
        ...
        $second_price     = \EstateSite\Core\Property::get( get_the_ID(), 'sec_price' );
