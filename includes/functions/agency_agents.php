...
if( !function_exists('houzez_get_agents_callback') ) {
    function houzez_get_agents_callback( $query_args ) {
        ...
        $agent_cats = get_post_meta( $page_id, 'fave_agent_category', false ) /* TODO unmapped fave_ key: fave_agent_category */;
        $agent_cities = get_post_meta( $page_id, 'fave_agent_city', false ) /* TODO unmapped fave_ key: fave_agent_city */;
        $order = get_post_meta( $page_id, 'fave_agent_order', true ) /* TODO unmapped fave_ key: fave_agent_order */;
        $orderby = get_post_meta( $page_id, 'fave_agent_orderby', true ) /* TODO unmapped fave_ key: fave_agent_orderby */;
