...
CSF::createSection( $prefix, array(
    ...
    'fields'        => array(
        ...
        array(
            ...
            'desc' => esc_html__('Select website container width.', 'houzez'),
            'options' => array(
                '1210px' => '1170px',
                '1310px' => '1270px',
                '1410px' => '1370px',
        ...
        array(
            ...
            'desc' => esc_html__( 'Show back to top button', 'houzez' ),
            'default'  => 1,
        ...
        array(
            ...
            'desc' => esc_html__( 'Show home link in front-end dashboard?', 'houzez' ),
            'default'  => 0,
            'on'       => esc_html__( 'Yes', 'houzez' ),
            'off'      => esc_html__( 'No', 'houzez' ), 
        ),
        array(
            ...
            'desc' => esc_html__( 'Configure automatic excerpt for property descriptions', 'houzez' ),
            'indent'   => true,
        ),
        ...
        array(
            ...
            'desc' => esc_html__( 'Automatically add "Read More" after specified words/lines', 'houzez' ),
        ...
        array(
            ...
            'desc' => esc_html__( 'Number of words to show before "Read More"', 'houzez' ),
        ...
        array(
            ...
            'desc' => esc_html__( 'Text for the read more link', 'houzez' ),
        ...
        array(
            ...
            'desc' => esc_html__( 'Show footer for half map template & half map search page?', 'houzez' ),
            'default'  => 1,
            'on'       => esc_html__( 'Yes', 'houzez' ),
            'off'      => esc_html__( 'No', 'houzez' ), 
        ),
        array(
            ...
            'desc' => esc_html__( 'Login required for add to favorites?', 'houzez' ),
            'default'  => 0,
            'on'       => esc_html__( 'Yes', 'houzez' ),
            'off'      => esc_html__( 'No', 'houzez' ), 
        ),
        array(
            ...
            'desc' => esc_html__( 'Show breadcrumb', 'houzez' ),
            'default'  => 1,
            'on'       => esc_html__( 'Yes', 'houzez' ),
            'off'      => esc_html__( 'No', 'houzez' ), 
        ),
        array(
            ...
            'desc' => esc_html__( 'Show full phone number for agents, agencies across the site.', 'houzez' ),
            'default'  => 1,
            'on'       => esc_html__( 'Yes', 'houzez' ),
            'off'      => esc_html__( 'No', 'houzez' ), 
        ),
        array(
            ...
            'desc' => esc_html__( 'Show image caption for property detail page gallery?', 'houzez' ),
            'default'  => 0,
            'on'       => esc_html__( 'Yes', 'houzez' ),
            'off'      => esc_html__( 'No', 'houzez' ),
        ),
        array(
            ...
            'desc' => esc_html__( 'Show image caption for popup gallery?', 'houzez' ),
            'default'  => 0,
            'on'       => esc_html__( 'Yes', 'houzez' ),
            'off'      => esc_html__( 'No', 'houzez' ),
        ),
        ...
        array(
            ...
            'desc'  => esc_html__( 'This applies for the calendar field type available for properties.', 'houzez' ),
        ...
        /*array(
            ...
            'desc'  => esc_html__( 'Select default country', 'houzez' ),
            'options'   => $Countries,
            'default' => 'US'
        ),*/
        ...
        array(
            ...
            'desc' => esc_html__( 'Restrict user admin panel access', 'houzez' ),
            'default'  => 1,
            'on'       => esc_html__( 'Yes', 'houzez' ),
            'off'      => esc_html__( 'No', 'houzez' ),
        ),
        ...
        array(
            ...
            'desc' => esc_html__('Select templates which you want to remove from template list when add new page', 'houzez'),
            'options' => array(
        ...
        array(
            ...
            'desc' => esc_html__('Select which taxonomy filters you want to disable.', 'houzez'),
            'options' => array(
        ...
        array(
            ...
            'desc' => esc_html__( 'Enable/Disable property measurement unit globally, it will overwrite measurement unit added for single properties', 'houzez' ),
            'default'  => 0,
            'on'       => esc_html__( 'Enabled', 'houzez' ),
            'off'      => esc_html__( 'Disabled', 'houzez' ),
        ),
        array(
            ...
            'desc'  => esc_html__( 'Select the measurement unit you will use on the website', 'houzez' ),
        ...
        array(
            ...
            'desc'  => esc_html__( 'Enter text for square feet', 'houzez' ),
            'default' => 'sqft'
        ),
        array(
            ...
            'desc'  => esc_html__( 'Enter text for square meters', 'houzez' ),
            'default' => 'm²'
        ),
        ...
        array(
            ...
            'desc' => esc_html__( 'Enable/Disable Scroll to top', 'houzez' ),
            'default'  => 1,
            'on'       => esc_html__( 'Enabled', 'houzez' ),
            'off'      => esc_html__( 'Disabled', 'houzez' ),
        ),*/
        array(
            ...
            'desc'     => esc_html__('Select in which page templates you want the sidebars to be sticky', 'houzez'),
            'options'  => array(
