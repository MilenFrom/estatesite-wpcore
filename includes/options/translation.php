...
CSF::createSection( $prefix, array(
    ...
    'fields'        => array(
        array(
            ...
            'type'     => 'section',
            'title'    => '',
            'desc' => esc_html__('Manage common strings accross site', 'houzez'),
            'indent'   => true,
        ),
...
CSF::createSection( $prefix, array(
    ...
    'fields'        => array(
        array(
            ...
            'type'     => 'section',
            'title'    => '',
            'desc' => esc_html__('Manage labels for searches accross the site', 'houzez'),
            'indent'   => true,
        ),
    ...
    'fields'        => array(
        ...
        **------------------------------------------------------------*/
        array(
            ...
            'desc' => esc_html__('Manage Single Property page section titles', 'houzez'),
            'indent'   => true,
        ),
        ...
        array(
            ...
            'desc' => esc_html__('Manage property detail page labels', 'houzez'),
            'indent'   => true,
        ),
        ...
        array(
            ...
            'desc' => esc_html__('Manage labels for agent contact forms and schedule tour', 'houzez'),
            'indent'   => true,
        ),
        ...
        array(
            ...
            'desc' => esc_html__('Manage labels for energy class section', 'houzez'),
            'indent'   => true,
        ),
        ...
        array(
            ...
            'desc' => esc_html__('Manage labels for mortgage calculator section', 'houzez'),
            'indent'   => true,
        ),
...
CSF::createSection( $prefix, array(
    ...
    'fields'        => array(
        ...
        array(
            ...
            'desc' => esc_html__('Manage buttons and links titles front-end', 'houzez'),
            'indent'   => true,
        ),
        ...
        array(
            ...
            'type'     => 'section',
            'title'    => esc_html__('Sections Titles', 'houzez'),
            'desc' => esc_html__('Manage create listing page section titles front-end and admin', 'houzez'),
            'indent'   => true,
        ),
...
CSF::createSection( $prefix, array(
    ...
    'fields'        => array(
        array(
            ...
            'type'     => 'section',
            'title'    => '',
            'desc' => esc_html__('Manage labels for agencies & agency detail page', 'houzez'),
            'indent'   => true,
        ),
...
CSF::createSection( $prefix, array(
    ...
    'fields'        => array(
        array(
            ...
            'type'     => 'section',
            'title'    => '',
            'desc' => esc_html__('Manage labels for dashboard menu', 'houzez'),
            'indent'   => true,
        ),
