...
CSF::createSection( $prefix, array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'desc' => esc_html__( 'Assign a property to several agents', 'houzez' ),
            'default'  => 0,
        ...
        array(
            ...
            'desc' => esc_html__( 'Enable range inputs for bedrooms, rooms and bathrooms fields. Example( 3 - 5, 2 - 4)', 'houzez' ),
            'default'  => 0,
            'on'       => esc_html__( 'Enable', 'houzez' ),
            'off'      => esc_html__( 'Disable', 'houzez' ),
        ),
        ...
        array(
            ...
            'desc' => esc_html__('Allow multiple selection of property types', 'houzez'),
            'default'  => 0,
        ...
        array(
            ...
            'desc' => esc_html__('Allow multiple selection of property status', 'houzez'),
            'default'  => 0,
            'on'       => esc_html__( 'Yes', 'houzez' ),
            'off'      => esc_html__( 'No', 'houzez' ),
        ),
        ...
        array(
            ...
            'desc' => esc_html__('Allow multiple selection of property labels', 'houzez'),
            'default'  => 0,
            'on'       => esc_html__( 'Yes', 'houzez' ),
            'off'      => esc_html__( 'No', 'houzez' ),
        ),
        ...
        array(
            ...
            'desc'	=> esc_html__( 'Default option for area prefix.', 'houzez' ),
            'options'	=> array(
                'SqFt' => 'Square Feet - ft²',
                'm²' => 'Square Meters - m²',
            ),
        ...
        array(
            ...
            'desc' => esc_html__( 'Enable/Disable auto generate property id', 'houzez' ),
            'default'  => 0,
        ...
        array(
            ...
            'desc'  => esc_html__( "Enter pattern for property id. Example HZ-{ID}", 'houzez' ),
            'default' => '{ID}',
        ...
        array(
            ...
            'desc'  => esc_html__( "Enter prefix for property id, leave empty if you don't want to show prefix. Example HZ-", 'houzez' ),
            'default' => ''
        ),
        array(
            'id'       => 'max_prop_images',
            ...
            'desc' => esc_html__('Maximum images allow for single property.', 'houzez'),
            'default' => '50'
        ),
        array(
            ...
            'desc' => esc_html__('Maximum upload image size. For example 10kb, 500kb, 1mb, 10m, 100mb', 'houzez'),
            'default' => '12000kb'
        ),
        array(
        ...
        array(
            ...
            'desc' => esc_html__('Maximum upload attachment size. For example 10kb, 500kb, 1mb, 10m, 100mb', 'houzez'),
            'default' => '3000kb'
        ),
    )
));
...
CSF::createSection( $prefix, array(
    ...
    'fields' => array(
        array(
            ...
            'desc'    => 'Drag-and-drop each module to quickly organize your property submission form layout',
            'options' => array(
                'enabled'  => array(
...
CSF::createSection( $prefix, array(
    ...
    'fields' => array(
        array(
            ...
            'desc'    => 'Drag-and-drop each module to quickly organize the form fields order of Property Details section.',
            'options' => array(
        ...
        array(
            ...
            'desc' => esc_html__('Select which fields you want to disable from the Add New Property form', 'houzez'),
            'options'  => array(
...
CSF::createSection( $prefix, array(
    ...
    'fields' => array(
        array(
            ...
            'desc' => esc_html__( 'Limit Title length for add listing', 'houzez' ),
            'default'  => 0,
            'on'       => esc_html__( 'Enabled', 'houzez' ),
            'off'      => esc_html__( 'Disabled', 'houzez' ),
        ),
        array(
            ...
            'desc' => esc_html__( 'Enter number of allowed characters.ie 150', 'houzez' ),
            'default'  => '',
            'validate'  => 'numeric',
        ...
        array(
            ...
            'desc' => esc_html__( 'Make at least 1 gallery image required?', 'houzez' ),
            'default'  => 1,
            'on'       => esc_html__( 'Enabled', 'houzez' ),
            'off'      => esc_html__( 'Disabled', 'houzez' ),
        ),
        array(
            ...
            'desc' => esc_html__('Select which fields of the Add New Property form are mandatory', 'houzez'),
