...
CSF::createSection( $prefix, array(
    ...
    'fields'		=> array(
        ...
        array(
            ...
            'desc'	=> esc_html__( 'The retina logo have to be double size of the regular logo', 'houzez' ),
        ...
        array(
            ...
            'desc'	=> esc_html__( 'Upload the favicon.', 'houzez' ),
        ),
        ...
        array(
            ...
            'desc'	=> esc_html__( 'Upload the iPhone icon (57px by 57px).', 'houzez' ),
        ),
        ...
        array(
            ...
            'desc'	=> esc_html__( 'Upload the iPhone retina icon (114px by 114px).', 'houzez' ),
        ),
        ...
        array(
            ...
            'desc'	=> esc_html__( 'Upload the iPad icon (72px by 72px).', 'houzez' ),
        ),
        ...
        array(
            ...
            'desc'	=> esc_html__( 'Upload the iPad retina icon (144px by 144px).', 'houzez' ),
        )
    ),
) );
...
CSF::createSection( $prefix, array(
    ...
    'fields'        => array(
        array(
            ...
            'read-only' => false,
            'default'   => array( 'url' => '' ),
            'desc'  => esc_html__( 'Upload logo for lightbox.', 'houzez' ),
        )
    ),
) );
