...
CSF::createSection( $prefix, array(
    ...
    'fields'           => array(
        array(
            ...
            'options'  => array(
                '1' => HOUZEZ_IMAGE . 'header/header-style-1.jpg',
                '2' => HOUZEZ_IMAGE . 'header/header-style-2.jpg',
                '3' => HOUZEZ_IMAGE . 'header/header-style-3.jpg',
                '4' => HOUZEZ_IMAGE . 'header/header-style-4.jpg',
                '5' => HOUZEZ_IMAGE . 'header/header-style-5.jpg',
                '6' => HOUZEZ_IMAGE . 'header/header-style-6.jpg',
        ...
        array(
            ...
            'desc' => esc_html__( 'Call us number in header', 'houzez' ),
        ...
        array(
            ...
            'desc' => esc_html__('Recommended size 85 x 85', 'houzez'),
            'default'   => array(
...
CSF::createSection( $prefix, array(
    ...
    'fields'           => array(
        array(
            ...
            'desc' => esc_html__('Only for header style 2, 3 and the top bar', 'houzez'),
...
CSF::createSection( $prefix, array(
    ...
    'fields'           => array(
        ...
        array(
            ...
            'desc' => esc_html__('Enable or disable custom link for create listing button ', 'houzez'),
            'default'  => 0,
            'on'       => esc_html__( 'Enabled', 'houzez' ),
            'off'      => esc_html__( 'Disabled', 'houzez' ),
        ...
        array(
            ...
            'desc' => esc_html__('Enter link. Ex: http://website.com/pagelink ', 'houzez'),
            'default'  => '',
